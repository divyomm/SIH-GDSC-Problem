...
function Form() {
  ...
  return (
    <div className=' bg-[#d9dbf1] p-16 rounded-2xl '> 
       ...
       <UserTag user={session?.user} />
        ...
        border-b-[2px] border-gray-400 placeholder-gray-400 py-4 my-4 rounded-lg'/>
        ...
        border-b-[2px] border-gray-400 placeholder-gray-400 rounded-lg'/>
          <input type="text"
